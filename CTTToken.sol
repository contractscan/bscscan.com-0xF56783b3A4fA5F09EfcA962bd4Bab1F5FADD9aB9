...
contract VestingWallet is Ownable {
    ...
    constructor(address _beneficiary, uint256 _start, uint256 _duration, uint256 _interval,uint256 _initialTokens) {
 ...
 * @dev CTTToken
 */
contract CTTToken is ERC20,Ownable {

    bool private isEnableTransfer;
    //[500000000000000000000000000,100000000000000000000000000,50000000000000000000000000,50000000000000000000000000,100000000000000000000000000,100000000000000000000000000,100000000000000000000000000]
    ...
    function _beforeTokenTransfer(
        ...
        require(isEnableTransfer || msg.sender == owner(),"Please Waiting Transfer");
    }

    function setEnableTransfer(bool isEnable_) public onlyOwner{
        isEnableTransfer = isEnable_;
    }
}